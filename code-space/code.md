...
In addition to standard indented code blocks, pandoc
supports *fenced* code blocks. These begin with a row of three or more
...
use this information to do syntax highlighting. Currently, the only
...
--list-highlight-languages.) Otherwise, the code block above will appear
as follows:
...
block to be numbered, starting with 1 or the value of
the startFrom attribute. The lineAnchors (or line-anchors) class will
...
To prevent all highlighting, use
the [--syntax-highlighting=none](https://pandoc.org/MANUAL.html#option--syntax-highlighting) option.
To set the highlighting style or method,
use [--syntax-highlighting](https://pandoc.org/MANUAL.html#option--syntax-highlighting).
For more information on highlighting, see [Syntax
highlighting](https://pandoc.org/MANUAL.html#syntax-highlighting),
below.
...
This syntax is borrowed
from [reStructuredText](https://docutils.sourceforge.io/docs/ref/rst/introduction.html).
